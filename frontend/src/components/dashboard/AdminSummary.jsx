...
function AdminSummary() {
  return (
    <div className='p-6' >
      ...
      <div className='grid grid-clos-1 md:grid-cols-3 gap-4 mt-6' >
        <SummaryCard icon={<FaUsers />} text="Total Employees" number={15} color="bg-teal-600" />
        <SummaryCard icon={<FaBuilding/>} text="Total Departments" number={9} color="bg-yellow-600" />
        <SummaryCard icon={<FaMoneyBillWave />} text="Montly Pay" number="$2500" color="bg-red-600" />
      </div>
      <div className='mt-12' >
